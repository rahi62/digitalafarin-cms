...
export type ResolvedPage={site:{name:string;domain:string;language:string};content:CmsEntry;blocks:CmsBlock[];seo:CmsSeo|null;schemas:CmsSchema[];breadcrumbs:{title:string;path:string}[];related_content:{id:string;title:string;path:string;excerpt:string}[]};
